...
export default class Profile extends Component {
  ...
  getThemeStyles = () => {
    ...
    const themes = {
      ...
      dark: {
        ...
        cardBackground: 'rgba(40,40,40,0.95)',
        textColor: '#e2e8f0',
  ...
  render() {
    const { user, isEditing, editedUser, activeTab, notifications, privacy, theme, language, showDeleteConfirm } = this.state
    const themeStyles = this.getThemeStyles()

    if (!user.email) {
      return (
        <div style={{ textAlign: 'center', padding: '50px' }}>
          <h2 style={{ color: themeStyles.textColor }}>Please login to view your profile</h2>
          <button 
    ...
    return (
      <div style={{ 
        ...
        <div style={{
          ...
          borderRadius: '20px',
          marginBottom: '30px',
          boxShadow: `0 15px 35px ${themeStyles.shadowColor}`,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '25px' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ margin: '0 0 5px 0', color: themeStyles.mutedTextColor, fontSize: '18px' }}>
                📧 {user.email}
              </p>
              <p style={{ margin: '0', color: themeStyles.mutedTextColor, fontSize: '14px' }}>
        ...
        <div style={{
          ...
          {activeTab === 'general' && (
            <div>
              <h2 style={{ marginBottom: '30px', color: themeStyles.textColor }}>👤 General Information</h2>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '25px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: themeStyles.textColor }}>
                    First Name
                  </label>
                  <input
                    type="text"
                    ...
                    style={{
                      ...
                      borderRadius: '10px',
                      fontSize: '16px',
                      background: isEditing ? (theme === 'dark' ? '#2d3748' : 'white') : themeStyles.inputBackground,
                ...
                <div>
                  ...
                  />
                  <small style={{ color: themeStyles.mutedTextColor, fontSize: '12px' }}>
          ...
          {activeTab === 'security' && (
            <div>
              <h2 style={{ marginBottom: '30px', color: themeStyles.textColor }}>🔒 Security Settings</h2>
          ...
          {activeTab === 'notifications' && (
            <div>
              <h2 style={{ marginBottom: '30px', color: themeStyles.textColor }}>🔔 Notification Preferences</h2>
              <div style={{ display: 'grid', gap: '20px' }}>
                {Object.entries(notifications).map(([key, value]) => (
                  ...
                  >
                    <div>
                      <h4 style={{ margin: '0 0 5px 0', color: themeStyles.textColor }}>
          ...
          {activeTab === 'privacy' && (
            <div>
              <h2 style={{ marginBottom: '30px', color: themeStyles.textColor }}>🛡️ Privacy Settings</h2>
              <div style={{ display: 'grid', gap: '20px' }}>
          ...
          {activeTab === 'preferences' && (
            <div>
              <h2 style={{ marginBottom: '30px', color: themeStyles.textColor }}>⚙️ Preferences</h2>
              <div style={{ display: 'grid', gap: '25px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '15px', fontWeight: '600', color: themeStyles.textColor }}>
                    🎨 Theme
                  </label>
                  <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                    {['light', 'dark', 'auto'].map(themeOption => (
                      <button
                        key={themeOption}
                        onClick={() => this.handleThemeChange(themeOption)}
                        style={{
                          background: theme === themeOption ? 'linear-gradient(135deg, #667eea, #764ba2)' : (theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.8)'),
                          color: theme === themeOption ? 'white' : (theme === 'dark' ? '#e2e8f0' : '#667eea'),
                          border: theme === themeOption ? 'none' : `2px solid ${theme === 'dark' ? '#e2e8f0' : '#667eea'}`,
                          padding: '12px 24px',
                          borderRadius: '15px',
                          fontSize: '14px',
                          fontWeight: '600',
                          ...
                          transition: 'all 0.3s ease',
                          boxShadow: theme === themeOption ? '0 8px 25px rgba(102, 126, 234, 0.3)' : 'none'
                        }}
                      >
                  ...
                  <p style={{ 
                    ...
                    {theme === 'auto' ? 'Theme follows your system preference' : 
                     theme === 'dark' ? 'Dark theme is easier on the eyes' : 
